...
SELECT TOP 31 COUNT(MEDICALRECORD_ID) AS TOTAL, CONCAT(YEAR(DATE), '/', MONTH(DATE), '/', DAY(DATE)) 
AS DATE FROM MEDICALRECORD WHERE
DATE BETWEEN '2023/02/01' AND '2023/02/4'
